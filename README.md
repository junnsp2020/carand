...
**～バッジの通知機能～**  
自分がやるべきことがある時に数字で教えてくれます。  
数字が大きい場合は、取引を進行できていない可能性が高いため、  
早めに進めてください。(※ 下図、赤矢印をご参照ください)      

**～メッセージの通知機能～**  
必ずしもやるべきことではないが、確認が必要な  
アクションが発生しているときに、メッセージは表示されます。  
(ex. 取引相手からのメッセージが届いた場合や、商品の購入はされたが  
入金待ちの場合等に表示されます)  
